...
2. Uniqueness: Suppose the contrary, let $|\ |'$ be another extension of $|\ |$. Let $\mathfrak{P}$ ($\mathfrak{P}'$) be the maximal ideal of $\mathcal{O}$ ($\mathcal{O}'$). We are going to proof that $\mathcal{O}=\mathcal{O}'$, in fact, we only need to proof that $\mathcal{O} \subseteq \mathcal{O}'$. Take $\alpha \in \mathcal{O} \backslash \mathcal{O}'$, with minimal polynomial $f$, then we know that all coefficents of $f$ are in $\small\mathcal{O}$ and $\alpha ^{-1} \in \mathfrak{P}'$, hence $1$