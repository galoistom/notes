...
1. Existence: Let $\small\small\mathcal{O}$ be the valuation ring of $K$ and $\small\mathcal{O}$ is its integral closure in $L$. Then one has $\small\mathcal{O}=\{ \alpha \in L | N_{L|K}(\alpha) \in \small\mathcal{O} \}$. We already know that $\alpha \implies N_{L|K}(\alpha) \in \small\mathcal{O}$. Conversly, if $\alpha\in L^{*}$ and $N_{L|K}(\alpha) \in \small\small\mathcal{O}$ 