...
As to the general case. Take $W$ a submodule of $V$. Assume $\mathcal{V}$ to be the submodule of $Hom(V,W)$, containing $f$ with $f|_{W}$ a scalar, and $\mathcal{W}$ it those $f|_{W}=0$. Then $\mathcal{W}$ is a submodule of $\mathcal{V}$ of codimension 1, hence $\mathcal{V} / \mathcal{W}$ is of dimension 1