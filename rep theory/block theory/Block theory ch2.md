...
*Proof*:
The equivalence of 1,2 are already proved above (the special case of $C=0$). The map $A \otimes_{B} U \rightarrow U$ has a section as $B$-homomorphism, namely the map sending $u \in U$ to $1 \otimes u$. Thus 3 implies 2. We need to show that 2 implies 3. 