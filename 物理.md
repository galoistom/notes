...
- 等压过程: $dU=dQ-dW=C_{p}dT-pdV=C_{p}dT-d(pV)$. 定义态函数焓: $H=U+pV$. 

$C_{p}=C_{v}+vR$. 注意到 $U=\frac{1}{2}(t+r+2s)vRT$, $H=U+vR$, 或者 $dU=C_{V}dT+\left((C_{p}-C_{V})\cdot \left(\frac{\partial T}{\partial V}\right)-p \right)dV$. 
