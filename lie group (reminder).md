...
Now our nect goal is the case of dimension 3. Still, we consider $[\ ,\ ]$ as a linear map, and devide the case of lie algebra in to the cases 0,1,2 or 3. For the case 0, it is $\mathfrak{g}$ is albelian, and the way of classification is just the same as above. As to the case 1, 